package JOOP_06_2_Reflection_and_Annotations_Ex;

import JOOP_06_2_Reflection_and_Annotations_Ex.Person;
...
public class Demo {
    ...
    public static void main(String[] args) throws NoSuchMethodException, InvocationTargetException, InstantiationException, IllegalAccessException {
        ...
        Person peter = publicConstructor.newInstance("Peter", 20); // new JOOP_06_2_Reflection_and_Annotations_Ex.Person("Peter", 20);
        Person privatePerson = privateConstructor.newInstance(); // new JOOP_06_2_Reflection_and_Annotations_Ex.Person();
...
//        System.out.printf("JOOP_06_2_Reflection_and_Annotations_Ex.Person is %s %s\n", privatePerson.getName(), privatePerson.lastName);

...
public class Main {
    public static void main(String[] args) {
        ...
        Child childOne = new Child("Sara", "Petrova", 3, "Selena", "0899");
        ...
        Child childFive = new Child("Sara", "Kostadinova", 3,"Nikolas", "0788");
        Child childSix = new Child("Sara", "Todorov", 2,"Zendaya", "0799");
        Child childSeven = new Child("Sara", "Gomez", 2,"Victor", "0998");
        Child childEight = new Child("Sara", "Thunberg", 3,"Boris", "0999");
